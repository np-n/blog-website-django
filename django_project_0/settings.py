...
# We should add application to ensure there is no match while getting templates in new apps
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
# Getting  secret information such as email(username) and password from Enviroment variable
